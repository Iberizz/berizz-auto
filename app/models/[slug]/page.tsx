...
export default function ModelPage() {
  ...
  return (
      <main className="bg-white min-h-screen">
        ...
        <section
            ref={heroRef}
            className="relative h-screen bg-gradient-to-r from-[#d8d8d8] via-[#e8e8e8] to-[#d8d8d8] overflow-hidden pt-[52px]"
        >
          <motion.div
          ...
          >
            <Link
                href="/#models"
                className="flex items-center gap-2 text-[11px] tracking-[3px] uppercase text-black/50 hover:text-[#E31F2C] transition-colors"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 h-full">
            ...
            {/* Car image avec transition couleur */}
        ...
        {/* ── SPECS ────────────────────────────────────────────────────────── */}
        <section ref={specsRef} className="bg-black text-white py-28 md:py-40 px-8 md:px-20">
          <motion.div
          ...
          <span className="text-[11px] font-medium tracking-[5px] uppercase text-[#E31F2C] block mb-4">
            ...
            <h2 className="font-black text-[clamp(40px,5vw,72px)] uppercase tracking-tight leading-[0.95]">
              Des chiffres qui<br />
              <em className="text-[#E31F2C] not-italic">parlent.</em>
            </h2>
          </motion.div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/10 max-w-4xl">
            {[
              { label: 'Motorisation', value: model.tagline },
              { label: 'Prix de base', value: formatPrice(model.base_price) },
              { label: 'Couleurs', value: `${colors.length} teintes` },
              { label: 'Disponibilité', value: 'Sur commande' },
            ].map((spec, i) => (
                <motion.div
                    key={i}
                    initial={{ opacity: 0, y: 30 }}
                ...
                >
                  ...
                  <div className="font-black text-[24px] md:text-[32px] leading-tight tracking-tight">
                    {spec.value}
                  </div>
                  <div className="text-[10px] md:text-[11px] font-light tracking-[3px] uppercase text-white/40 mt-3">
                    {spec.label}
                  </div>
                </motion.div>
            ))}
        ...
        {/* ── GALERIE ──────────────────────────────────────────────────────── */}
        <section ref={galleryRef} className="bg-white py-28 md:py-40 px-8 md:px-20">
          <motion.div
              initial={{ opacity: 0, y: 40 }}
